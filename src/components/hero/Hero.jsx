  ...
  return (
    <div className="bg-gray-100 flex flex-col items-center py-10 px-4 text-center md:flex-row md:justify-around md:text-left">
      ...
      <section className="flex flex-col items-center gap-4 max-w-md md:max-w-lg md:items-start w-full md:w-auto ">
        <h1 className="text-gray-700 font-semibold text-xl md:text-5xl leading-tight">
        ...
        <button className="bg-green-500 text-[14px] md:text-[18px] text-white px-6 py-2 rounded-md shadow-md hover:bg-green-400 transition duration-300 md:px-8 md:py-4 md:mt-6">
          Register
        </button>
      </section>
